#+title: ASTR545 - GW progenitors
#+author: Mathieu Renzo
#+email: mrenzo@arizona.edu
#+PREVIOUS_PAGE: notes-lecture-SNe.org
#+NEXT_PAGE: notes-lecture-SNIa.org
...
:Question:
- *Q*: For which stars do you expect GR to be important?
:end:
...
Today, while observations continue, we know of $\sim250$ BBH mergers, a
...
evolution" (see [[./notes-lecture-CE.org][corresponding lecture notes]] and references therein).
...
6. (next column) A second phase of mass transfer will occur. In this
   ...
   *shortening the orbital separation* (this is the key for GW
   ...
   such as Thorne-Zytkow objects or quasi-stars, cf. e.g., [[https://ui.adsabs.harvard.edu/abs/1975ApJ...199L..19T/abstract][Thorne &
   Zytkow 1975]], [[https://ui.adsabs.harvard.edu/abs/2024arXiv241002896O/abstract][O'Grady et al. 2024]], or possibly an interesting
   transient, e.g., [[https://ui.adsabs.harvard.edu/abs/2025Ap%26SS.370...11G/abstract][Grichener 2025]])
...
Multiple dense stellar environment have been proposed:
 ...
 - nuclear star cluster: these are clusters around the supermassive BH
   ...
   products and get multiple "generations" of mergers. However, the
   presence of a large mass can also increase the velocity dispersion,
   lowering the cross-section for encounters.
...
#+CAPTION: LIGO, VIRGO, and KAGRA are three ground-based GW observatories. This figure shows the predicted uptime for each detector with the horizon out to which they are predicted to be able to detect an optimally ordiented BNS merger. From [[https://observing.docs.ligo.org/plan/]].
#+ATTR_HTML: :width 100%
...
Restricting the view to *merging* (so high-frequency GW $\Rightarrow$ ground based
detectors) *stellar-mass* ($M\lesssim 500M_{\odot}$) sources, based on the
projected improvements in sensitivity and inferred rates, we can
predict how many detection are expected. The animation below shows the
cumulative distribution of BBH, BNS, and BHNS mergers detected (up to
the beginning of the $4^{\rm th}$ LVK observing run - O4) and projection
into the future. CE/ET stands for Cosmic Explorer/Einstein Telescope,
planned $3^{\rm rd}$ generation ground-based GW-detectors. Note that the
predictions from 2024 are quite on spot as of 2026. Credits:
[[https://arxiv.org/abs/2303.17628][Broekgaarden et al. 2024]], source of the animation [[https://zenodo.org/records/10995271][in this
reproducibility package]].

#+HTML: <video  controls width="600" height="400" src="./images//GWcatalogSize.mp4" </video>
#  [[./images/GWcatalogSize.mp4]]
