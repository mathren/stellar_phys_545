...
the stars, and flattened by the centrifugal potential. Therefore, most
of the mass of the stars is still distributed quite spherically, and
only the outer layers with lower density deviate significantly from
this shape.
...
radius (implying a larger impact of tides, see [[./notes-lecture-tides.org][the corresponding
notes]]).
