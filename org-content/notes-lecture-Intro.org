...
because of the large number of parameters in (single) star models,
which would allow one to fit any observable.
...
SN1987A whose progenitor was a blue supergiant star (while, as we will
see, single star evolution only predicts red supergiants and possibly
H-free stars).
