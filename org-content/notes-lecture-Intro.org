...
#+CAPTION: Link to [[https://uarizona.co1.qualtrics.com/jfe/form/SV_br2BJii84cul3bE][Intro survey]]
#+ATTR_HTML: :width 50%
[[./images/QR-intro.png]]

#+CAPTION: Word cloud of the students' expectations for what they are going to learn in this class (Spring 2026 semester).
#+ATTR_HTML: :width 100%
[[./images/word_cloud20260114.png]]

* Who am I?

My name is Mathieu Renzo, I have been an assistant professor here at
Steward Observatory since 2024. Before, I was a postdoc in New York
city (at the Flatiron institute and Columbia University), and before
that I did my PhD at the University of Amsterdam in the Netherlands --
but I am originally from none of these places!
...
The scientific topic of this course is /very computationally oriented/:
stellar astrophysics is arguably one of the oldest computational
astrophysics problems. Throughout the course, I will try to highlight
what is the result of computer models based on necessary (but often
grossly oversimplifying) approximations and what is more solidly
grounded in observations. We will do this by having computational
exercises, hence the questions on your computational background and
MESA. We will start the course by going over the physical foundations,
but I will also ask you to use your own computer models too.

* Expectations
As graduate students you are *expected* to carry out independent work.
More importantly, this may be the last time in your career that it is
relatively "easy" to set time aside to learn new things.
...
textbook(s), and you will more likely have a better understanding if
you attend. Also, as we'll discuss in a moment, in-class participation
will count for up to 20% of your final grade, so if you want more than
a B you should come *and actively participate*.

*N.B.:* Active participation \neq just presence!
...
yourself and give them a chance to "pay back". In the end we will all
be better thanks to this dynamic.
...
* Discuss syllabus and schedule

Link to [[./syllabus.org][syllabus]] and [[./lectures.org][lecture schedule]].

* Discuss projects

Link to [[./projects.org][proposed projects page]].
...
- You should look over the [[file:projects.org::*List of possible projects/presentations][proposed project]], and give us a ranked list
  of 5 projects you'd like to do (see [[https://d2l.arizona.edu/d2l/home/1701369][D2L]] for updated deadline).
...
life may do some nuclear burning of light elements (e.g., deuterium).
This burning does not release a lot of energy (the deuterium nucleus,
a proton and a neutron bound together, has very low nuclear binding
energy), thus these objects sit at the boundary between planets and
stars.

** The ongoing "Renaissance" of stellar physics
Stellar physics was one of the first problems tackled with computers,
at the foundations of computational astrophysics since the early 1960s
(see for instance this [[https://repository.aip.org/kippenhahn-rudolf-1978-june-18][interview to R. Kippenhahn]]). By the 1980s-90s,
stellar evolution was considered a "solved problem": this was largely
because of the large number of parameters required to describe all the
atomic, nuclear, and radiative physics plus the stellar hydrodynamics,
which would allow in principle one to fit any given observable.

However, this was largely based on closed-source, non-reproducible
models of single stars only, and in fact, several cracks in this
picture were already evident, for example the famous explosion of
SN1987A, see Fig. 2, whose progenitor was a blue supergiant star
(while, as we will see, single star evolution only predicts red
supergiants and possibly H-free stars).


#+CAPTION: Right panel: the arrow points at the Blue supergiant progenitor Sanduleak -69 202 observed \sim one month before the explosion by the Anglo-Australian Telescope. Left panel: SN1987A saturating the same telescope. Zoom in shows the three ring morphology illuminated by the supernova.
#+ATTR_HTML: :width 100%
[[./images/87a_complete_zoom.png]]


The advent of /Gaia/ space-based astrometry, the direct detection of
gravitational waves, the expanded capabilities (in timing and depth)
of time-domain surveys and precision of photometry (allowing for
asteroseismology of large samples) with KEPLER first, TESS now, and
PLATO in the future have ushered a real renaissance of this field,
providing data and theoretical questions that require deeper
understanding of stellar physics. Together with the development of
*open-source* and *community-driven* tools to address these questions,
this has revived significantly the field of stellar evolution, so much
so that the [[https://www.nationalacademies.org/projects/DEPS-BPA-18-01][Astro2020 decadal survey]] identified understanding stellar
evolution and interactions as a key priority! In this course, we will
cover the basics needed to contribute to this efforts, and in the
second half, you will review some topics for which active research is
ongoing.
...
#+begin_latex
\begin{equation}
1\,\mathrm{pc} \simeq 3\times10^{18}\,\mathrm{cm} \simeq 2 \times 10^{5}\,{\rm au} \simeq 3\,\mathrm{light\ years} \ \ .
\end{equation}
#+end_latex
...
magnitude systems (e.g., Vega). In reality, typically magnitudes are
provided integrating over a range of frequencies (photometry!)
accounting for the response of a filter as a function of wavelength
T(\lambda):
...
** Lifetimes: $\sim$ 3 Myr to $\gg$ age of the Universe (\simeq 13.7 Gyr)
:Question:
...
** General considerations
  - As per the syllabus, homework should be your own production,
    ...
    homeworks yourself.
  - Always consult [[https://d2l.arizona.edu/d2l/home/1701369][D2L]] for official deadlines. If you need an
