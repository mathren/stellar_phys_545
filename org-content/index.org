#+title: ASTR/PTYS 545 Stellar Evolution
#+author: Mathieu Renzo
#+email: mrenzo@arizona.edu
#+PREVIOUS_PAGE: index.org
#+NEXT_PAGE: syllabus.org

* ASTR/PTYS 545 Theoretical Astrophysics - Stellar Evolution

Material developed for a one-semester graduate-level course at the
...
let me know and feel free to open an issue/PR on [[https://github.com/mathren/stellar_phys_545][GitHub]].

** How to use this website

This are my notes for lectures, and are intended to *complement* (not
substitute!) [[./syllabus.org::*Recommended textbooks and resources][other resources]].
...
will be on [[https://d2l.arizona.edu/d2l/home/1701369][D2L]].
