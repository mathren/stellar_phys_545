#+Title: ASTR545 - CCSNe and compact object formation
#+author: Mathieu Renzo
#+email: mrenzo@arizona.edu
#+NEXT_PAGE: notes-lecture-GWprog.org
#+PREVIOUS_PAGE: notes-lecture-CE.org

*Materials*: [[https://ui.adsabs.harvard.edu/abs/2012ARNPS..62..407J][Janka 2012]], [[https://ui.adsabs.harvard.edu/abs/2024OJAp....7E..31S/abstract][Soker 2023]], [[https://ui.adsabs.harvard.edu/abs/2022MNRAS.510.4689V][Burrows et al. 2023]], see also
[[https://lavinia.as.arizona.edu/~mrenzo/materials/cores_of_massive_stars.pdf][my guest lecture notes]] and references therein.
...
/not/ the only kind of supernova and/or transient that can be observed,
and our focus here excludes SNIa, pair-instability supernovae,
luminous red novae, tidal disruption events, gravitational-waves
mergers, etc. (see also [[./projects.org][projects]] and upcoming lectures on
[[./notes-lecture-GWprog.org][gravitational-wave merger progenitors]] and [[./notes-lecture-SNIa.org][SNIa]]).

* Gravity's victory over nuclear energy release

We have described the entire evolution of a star in terms of the
"gravothermal collapse" caused by the virial theorem $\langle T \rangle\propto M\mu/R$
temporarily delayed by energy release by thermonuclear nuclear burning
until either non-ideal-gas pressure terms stop the collapse (WD
formation) or the ultimate victory of gravity over the gas pressure
gradient.
...
capture SN" (cf. [[file:in-class-evol-wrap-up.org::*super-AGB stars and off-center C ignition][super-AGB evolution]]) instead of because electron captures
...
2024]], [[https://ui.adsabs.harvard.edu/abs/2025ApJ...987..164B/abstract][Burrows et al. 2025]]). But the details of the stellar structure
depend on the late burning stages (namely, [[./notes-lecture-nuclear-cycles.org::*Silicon core burning][Silicon burning]]) of the
star, and on the mixing processes during these phases:

#+CAPTION: Density profiles in the innermost $m\le3\,M_{\odot}$ of (single, solar-metallicity) CCSN progenitors at the onset of collapse (see below), from [[https://ui.adsabs.harvard.edu/abs/2016ApJ...821...38S/abstract][Sukhbold et al. 2016]] as plotted by [[https://ui.adsabs.harvard.edu/abs/2025ApJ...987..164B/abstract][Burrows et al. 2025]]. The details of the inner density profile, encountered first by the shock, will determine the SN outcome.
#+ATTR_HTML: :width 75%
[[./images/rho.png]]
...
** Core Bounce
Since the nuclei of the iron group ($50\lesssim A\lesssim 70$) are the
most tightly bound (cf. [[./notes-lecture-nuclear-burning.org][lecture on microphysics of nuclear reactions]]),
the fusion of two of them would require energy input greater than the
...
to collapse. The conventional definition for the onset of collapse is
...
arbitrary threshold! Eq. \ref{eq:onset_cc} is motivated by the
...
As the stellar core collapses and the density increases, the
...
*N.B.:* An old idea was that photodisintegration of Fe would be the main
energy loss, but that energy is still "trapped" in the core. The
neutrinos from electron captures can instead leak out causing real
losses and dominate the infall dynamics.
...
($\rho_{c}\sim10^{14}\,\mathrm{g\ cm^{-3}} \simeq \rho_{n} =2\times10^{14}\,\mathrm{g\ cm^{-3}}$) that
...
#+CAPTION: Golf ball bouncing: the shock wave created by the impact with the wall (analogous to the "core-bounce" reverting the infall velocity of the inner core) propagates through the ball changing the sign of momentum of all the parts of the ball.
#+ATTR_HTML: :width 20%
[[./images/ball.gif]]
...
and roughly speaking 100 times more that the typical explosion energy
...
explosion energy ($\int L_\mathrm{SN}(t)\,dt \simeq10^{49}\,\mathrm{erg}$).
Thus, the CCSN explosion problem is about how this energy can be
harvested by the shock to explode the star.

Therefore, a SN shock successful in exploding the star needs to
harvest \sim1% of the gravitational binding energy released by the
collapse of the core (mostly in the form of neutrinos).
...
et al. 2022]]), the shock is pushed by the large neutrino emission
from the innermost proto-NS region. These neutrinos are mostly
produced by electron captures to "neutronize" the Fe core (in the
innermost ``cooling-region'' where the proto-NS is), cf. Eq.
\ref{eq:ecap} and from [[./notes-lecture-neutrinos.org::*Thermal neutrinos][cooling processes]]. A small fraction of these
neutrinos will interact in a region behind the shock (the so-called
"gain-region"). This is because the stellar plasma has now densities
and temperatures higher than during core Si burning, and the cross
section for neutrino absorption is not negligible anymore.
...
As mentioned above, historically, spherically-symmetric numerical
simulations of core-collapse SNe would always find stalling and
ultimately receding shocks, that is failed explosions. This lead to
the realization that the /asymmetries/ in the flow (possibly seeded
before the onset of collapse) are a key ingredient to achieve a
...
Several sources of asymmetry (both local and global) exist before and
during the collapse of the core of a massive star:
- *before*: convective layers (e.g., Si shell burning) with local
  inhomogeneities caused by the convective flow can seed initial
  perturbations amplified by the collapse (see also [[https://ui.adsabs.harvard.edu/abs/2022ApJ...924L..15F/abstract][Fields 2022]]);
- *during*:The neutrino heat the bottom of the gain region, driving convection
  (a steep temperature and entropy gradient can develop because of the
  neutrino heating);
- *during*:Convection implies the presence of turbulent flow and an associated
...
- *during (or possibly "after")*: Standing accretion Shock Instability (SASI, [[http://adsabs.harvard.edu/abs/2003ApJ...584..971B][Blondin et al. 2003]], see
  ...
  same instability can develop in a table top experiment, see for
  example [[https://ui.adsabs.harvard.edu/abs/2012PhRvL.108e1103F/abstract][Foglizzo et al. 2012]]:
  #+HTML: <iframe width="560" height="315" src="https://www.youtube.com/embed/5fcsSA31rkE?si=HqK5-YUQQdO8k9p1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
- *during*: Lepton-number Emission Self-Sustained Asymmetry (LESA, [[https://ui.adsabs.harvard.edu/\#abs/2014ApJ...792...96T][Tamborra et al 2014]]),
...
#+HTML: <iframe width="560" height="315" src="https://www.youtube.com/embed/i-Ly8aCoF7E?si=gZ0c5HD17o-l3-pY&amp;start=11" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

*** Black hole formation: explosion or not?

Effectively, this is still an open question. BHs may form if this
explosion mechanism fails (possibly with very little more than the
disappearance of the star as a transient, see for instance [[https://ui.adsabs.harvard.edu/abs/2015MNRAS.450.3289G/abstract][Gerke et
al. 2015]], [[https://ui.adsabs.harvard.edu/abs/2021MNRAS.508.1156B/abstract][Basinger et al. 2021]],
[[https://ui.adsabs.harvard.edu/abs/2024arXiv241007055T/abstract][Tsuna
et al. 2024]], [[https://ui.adsabs.harvard.edu/abs/2026ApJ...999L..25D/abstract][De et al. 2026]]), /or/ with an explosions and a visible
transient anyways (see for instance [[https://ui.adsabs.harvard.edu/abs/2013ApJ...769..109L/abstract][Lovegrove & Woosley 2013]],
[[https://ui.adsabs.harvard.edu/abs/2019MNRAS.485L..83Q/abstract][Quartaet
et al. 2019]], [[https://ui.adsabs.harvard.edu/abs/2022MNRAS.511..176A/abstract][Antoni et al. 2022]]) -- it is possible both occur in
nature depending on the mass of the progenitor (and BH) considered and
this is highly debated presently.

Present-day consensus based on 3D neutrino-driven radiation
hydrodynamics simulation is that the most massive stellar cores, for
which the Si/O interface is at a large Lagrangian mass coordinate,
have very high accretion rates onto the shock early on, which do
provide large ram pressure, but also enhances the neutrino luminosity.
Ultimately, these models develop strong neutrino driven convection
that can (in 3D) drive a successful explosion with significant
fallback (in some of the directions) and still result in the formation
of a BH.
...
and accelerate it. A key prediction of this "tug-boat" model is that
the SN shock is faster in the direction opposite to the one in which
the compact object is accelerated. A faster shock is more efficient at
...
Note typically SN ejecta achieve velocities of $\sim10^{4}\,\mathrm{km\ s^{-1}}\gg
v_\mathrm{\rm orb}$, thus we can neglect the orbital motion of the binary
...
([[https://www.nature.com/articles/s41586-024-08120-6][Burge et al. 2024]], [[https://ui.adsabs.harvard.edu/abs/2023arXiv231001509V][Vigna-gomez et al. 2024]]) although observations of
the kinematic properties of X-ray binaries hosting BHs accreting mass
from a companion seem to require moderate kicks (see e.g., [[https://ui.adsabs.harvard.edu/abs/2019MNRAS.489.3116A/abstract][Atri et al.
2019]]).
...
associated to the thermonuclear obliteration of a white
dwarf (see also [[./notes-lecture-SNIa.org][corresponding lecture]]).
...
luminosity the driving mechanism is still unclear and may not be the
same for all events. Three proposed models exist:
 ...
 - Magnetar engine: if the NS formed by the collapsing inner core is
   ...
   these energy sources and be over-powered. See for example
   [[https://ui.adsabs.harvard.edu/abs/2015MNRAS.454.3311M/abstract][Metzger et al. 2015]].
...
star, effectively "whipping the star" and injecting energy throughout.


#+CAPTION: First day of a weak explosion: as time progresses (colors get lighter) we see the discontinuity in the $v(m)$ profile moving outward in mass coordinate: this is the SN shock traveling through the star and energizing each layer to (possibly) drive an explosion. By the end of this simulation, a lot ot the material has a positive velocity, with the outermost layers being fasters, indicating ejection. But matter below $m\sim5\,M_{\odot}$ has a negative velocity, indicating late ($\sim$1 day post-collapse) fallback. This is a =SNEC= spherically symmetric artificially driven (/thermal bomb) explosion of of the $30\,M_{\odot}$ solar metallicity donor star in a binary, which reaches the onset of core-collapse as a $12\,M_{\odot}$ stripped He core from [[https://ui.adsabs.harvard.edu/abs/2023ApJ...948..111F/abstract][Farmer et al. 2023]]. The cyan dotted line in the color bar marks the time of shock breakout.
#+ATTR_HTML: :width 75%
[[./images/Shock_whip.png]]


*N.B.:* The shock propagates faster than the local sound
...
more uncertain (see e.g., [[https://ui.adsabs.harvard.edu/abs/2024ApJ...976L..13G/abstract][Gottlieb et al. 2024]]). Rotation and magnetic
fields can produce a fast-spinning magnetar (NS with magnetic field in
excess of 10^{14} Gauss) which can transfer its initially high energy to
the ejecta helping the explosions.
...
facilities on the ground (e.g., Rubin/LSST and robotic networks of
$\sim1$\,m-class telescopes across the globe offering continuous coverage
unlimited by night-time) and in space (AstroSat, Roman), that will
contribute significant advances. Stellar evolution of the progenitors
is recognized as one of the key bottlenecks in better understanding
this problem, and a lot of efforts are being dedicated to
understanding better the evolution and explosion of massive stars,
which releases chemicals (e.g., C and O) and vasts amounts of energy
and momentum shaping the host galaxies.
...
Key open questions actively debated today include:
 ...
 - What is (if any) the role of rotation and magnetic fields in
   "normal" SNe? What drives the diversity of transients and
   especially the extremes (in $L$, duration, etc.)?
