...
- There are really two main cycles, the CN cycle and the NO (the
  ...
  and they are often referred to jointly as CNO cycle (*N.B.*: from the
  /spectrum/ of Solar neutrinos we know the CN cycle is happening in the
  Sun, although it is not dominating the energy generation).
