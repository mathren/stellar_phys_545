#+title: ASTR/PTYS 545 Syllabus - Stellar Evolution
...
* Where and when
Steward Observatory room *208*, Monday-Wednesday-Friday 11:00-11:50.
...
[[https://docs.mesastar.org/en/latest/][MESA]]. Students that have the resources and abilities can also directly
use their own local installation of MESA.
...
concepts, organizing your thoughts, and supporting your research.
However, /all work you submit must represent your own understanding,
analysis, and intellectual effort/. When you use generative AI in
preparing an assignment, you must:

1. Declare its use and describe how you employed it
...
of AI tools for a particular assignment, please ask.
...
The course grade will be based on:
 ...
 - Literature review project/presentation (written+oral): 30%
...
Assignments should be uploaded *in pdf form* via D2L and include a
minimal "reproducibility package" when involving code/data. The
reproducibility package can be limited to the bare minimal (source of
the data, scripts) and I will typically /not/ need to run your code,
unless necessary. The submission of the reproducibility package
*complements but does not substitute the submission of answers in pdf*.

Deadlines will be designed to use the homework materials in class.
*Late submissions will not be accepted unless explicitly agreed upon
beforehand*, if you expect not to make it on time, ask for an extension
*at least one day before the deadline*. It's better to submit something
incomplete than nothing. In your pdf files, you should show the
calculations done and contextualise them as appropriate.
...
There will be a mid-term take-home exam consisting of theoretical
questions, =MESA-web= (and/or MESA) based calculations, analysis and
interpretation. Like for the homework, a minimal reproducibility
